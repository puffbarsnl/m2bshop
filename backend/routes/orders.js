...
const { sendOrderShipped } = require("../middleware/mailersend");
  ...
  try {
    ...
    let currentDate = moment().format("DD-MM-YYYY");
		...
		if(req.body.delivery_status === "onderweg") {
			// sendOrderShipped(req.body.shipping.email, "Your order has been shipped", currentDate, `${req.body.shipping.line1} ${req.body.shipping.postal_code} ${req.body.shipping.city}`, moment(currentDate).add(14, 'days'));
			console.log(req.body.shipping.email, "Your order has been shipped", currentDate, `${req.body.shipping.address.line1} ${req.body.shipping.address.postal_code} ${req.body.shipping.address.city}`, moment().add(14, "days").format("DD-MM-YYYY"));
